...
if(isset($_GET['id']) ){
    $id = $_GET['id'] ;
    $select_qry = "SELECT * FROM new_user WHERE id = '$id'";
...
<article style="background-color: #ECEEF5;"class="container">
 <form action="facebook_reg.php" method="post">
 <input  type="hidden" name="id" value="<?=$id?>"/>  
		<div class="row">
			...
			<div class="col-sm-6">
                ...
                <span></span>
				  <input required="" autofocus="" autocomplete="" name="surname" type="text" value="<?=$surname?>" class="form-control" placeholder="Surname"> 
                  <input required="" name="firstname" autocomplete=""  value="<?=$firstname?>"type="text" class="form-control" placeholder="Firstname">
				...
				<div class="form-group">
				   <input required autocomplete="username" autofocus="" name="email"  value="<?=$email?>"type="text" class="form-control" placeholder="Mobile Number or Email Address">
				</div>

				<div class="form-group">
				   <input required autocomplete="current-password" name="password" value="<?=$password?>" type="text" class="form-control" placeholder="Password"/>
				</div>

				<div class="form-group">
				   <input name="repeatpassword" type="text"  value="<?=$repeatpassword?>" class="form-control" placeholder="Repeat Password">
				</div>
			...
			<label>Birth Date © </label>  
                    ...
                    <?php if($_GET['id']){ ?>
                         ...
                         <button class="btn btn-lg btn-primary btn-block signup-btn" type="update" name="update">
                        Update my account</button>
                        <br />
                <?php    }else{ ?>
                    
                     <button class="btn btn-lg btn-primary btn-block signup-btn" type="update" name="create">
